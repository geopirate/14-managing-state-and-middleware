...
const conString = process.env.DATABASE_URL || 'postgres://postgres:kilovoltdb@localhost:5432/kilovolt'; // TODO: Don't forget to set your own conString
...
// This function is using a proxy to contact github, send the token and recieve the request passed in
// The request comes from the app-get function on line 38 of this file
...
// these routes are redirecting the matching URLs to particular html pages
// The requests come from the URL bar in the browser or links
...
// DONE: What is this route doing? Where does it receive a request from?
// This article is updating an article in the database from an URL
// This is called from a URL request
